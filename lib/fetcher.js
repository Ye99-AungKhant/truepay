...
export async function verifyUserData(data) {
    console.log('verifyUserData req', data);
    ...
    if (res.ok) {
        console.log('verifyUserData res', res);
        return res.json();
    }
...
export async function transactionHistory(data) {
    const res = await fetch(`${config.API_URL}/transfer/history/${data}`, {
        method: "GET",
        headers: {
            "Content-Type": 'application/json',
        },
...
export async function getTransaction(data) {
    const res = await fetch(`${config.API_URL}/transfer/transaction-id/${data}`, {
        method: "GET",
        headers: {
            "Content-Type": 'application/json',
        },
